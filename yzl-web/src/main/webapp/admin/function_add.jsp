...
<div data-options="region:'center'">
	<form id="functionForm" action="${pageContext.request.contextPath}/function/addFunction" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						...
						<td>
						<input type="text" name="perms" class="easyui-validatebox" data-options="required:true" />				
						</td>
					</tr>
					<tr>
						<td>名称</td>

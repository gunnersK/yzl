...
<script type="text/javascript">
	...
	//添加
    function add(){
			location.href='${pageContext.request.contextPath}/admin/engineeringManage_add.jsp';
		}
		...
		if(rows.length>0){
			$.messager.confirm('提示','你确定要删除这'+ rows.length +'条数据吗？',function(r){
				if(r){
					...
					//把所有id拼起来，用","隔开
					var ids = array.join(",");
					$.post("${pageContext.request.contextPath}/deleteEpc",{"ids":ids},function(){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div id="tb">
    	...
    	<shiro:hasPermission name="sys:yhgl:xz">
    		<a class="easyui-linkbutton" id="addBtn" data-options="iconCls:'icon-add',plain:true" onclick="add()">添加工程</a>
    	</shiro:hasPermission>
    	
    	<shiro:hasPermission name="sys:yhgl:sc">
    		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="deldata()">删除工程</a>
    	</shiro:hasPermission>	
    </div>

		...
		$.ajax({
			...
			success:function(data){
					if(data.data==200){
						...
						$.messager.alert("提示框","列表中已存在该工程 ! !",'question');
					}
					//刷新页面
					$("#tab").datagrid('reload');
 ...
 <div class="user_Manager_style">
  ...
  <%-- <form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/addTemplate"> --%>
    ...
    <!-- <label class="label_name">地区名:</label>
		...
		&nbsp;&nbsp;&nbsp;
		<input class="easyui-combobox" id="epci" type="text" style="width: 205px; height: 30px;" data-options="valueField:'ecode',textField:'ename',url:'${pageContext.request.contextPath }/show_epc',panelHeight: 200,editable:false">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
	<label class="label_name">任务名:</label>
		&nbsp;&nbsp;&nbsp;
		<input class="easyui-combobox" id="taski" style="width: 400px; height: 30px;" data-options="valueField:'tcode',textField:'tname',url:'${pageContext.request.contextPath }/show_task',panelHeight: 200,multiple:true,editable:false">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
		<button class="btn btn-primary" id="addMel" type="submit">添加模板</button>
	<!-- </form> -->
		...
		<%-- <form id="editForm" action="${pageContext.request.contextPath }/updateUser" method="post"> --%><br><br>
			<table id="tba" class="table-edit" width="95%" align="center" data-options="">
	           	...
	           	<tr>
	           		...
	           		<td><input id="ecode" class="easyui-combobox" style="width: 205px; height: 25px;" data-options="valueField:'ecode',textField:'ename',url:'${pageContext.request.contextPath }/show_epc',panelHeight: 200,editable:false"></td>
				</tr>
   ...
   //修改按钮
    	 ...
    	 $.ajax({
    			 ...
    			 success:function (data){
    				 if(data.data==200){
    					 ...
    					 $.meaasger.alert("提示框",'<br><h1>修改失败 ! !</h1>','info');
    				 }
 		...
 		url:'${pageContext.request.contextPath}/show_template',
			...
			columns:[
						[
							...
							{align:'center',width:218, title:'工程名',			field:'ename'},
			...
			pageList:[10,15],
			toolbar:[
    			{iconCls:'icon-search',text:'查看',handler:viw},
    	 ...
    	 $.ajax({
    		 ...
    		 success:function(data){
    			 ...
    			 if(data.data==200){
    				 ...
    				 $.messager.alert('提示框','<br><h1>删除失败 ! !</h1>','info');
    			 } 
    			 $("#tab").datagrid('reload');
    		 },
    		 dataType:'json'
     ...
     $(function(){
    	 $.post(
    			 '${pageContext.request.contextPath }/show_task',
    			 function(data){
    				 //alert(data);

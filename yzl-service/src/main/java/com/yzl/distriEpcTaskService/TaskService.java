...
public interface TaskService {
	...
	List<YzlTask> queryByYearAndAreaCodeAndZLLBAndGCLB(String year,String areaCode,String ZLLB,String GCLB);
	...
	//-----------------与世隔绝
	List<YzlEpc> getTableHeader(String year,String disCode,String ZLLB);
}

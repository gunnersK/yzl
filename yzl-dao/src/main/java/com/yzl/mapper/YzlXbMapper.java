...
public interface YzlXbMapper {
   ...
   ////根据市的编号查询小班表中的拥有的县的编号
	...
	//查询下发的任务
	List<YzlEpcTaskProgress> selectByCityCountyTaskIssued(@Param("year")String year,@Param("menu")List<String> menu,@Param("gclb")String gclb,@Param("stats")List<String> stats);
